  ...
  <div class="xmind-context-top-actionbar">
    <div class="actionbar">
      <div
        ...
        :key="item.action">
        <div v-if="!item.list">
          <span v-if="!item.svgIcon" :class="`iconfont ${item.icon}`"></span>
        ...
        <a-dropdown v-else placement="bottom" overlayClassName="top-action-dropdown">
          <div>
            ...
            <a-menu>
              <a-menu-item v-for="itemName in item.list" :key="itemName.action">
                <a
                  ...
                  href="javascript:;"
                  style="font-size: 12px;">{{ itemName.name }}</a>
              </a-menu-item>
            </a-menu>
          </template>
        </a-dropdown>
